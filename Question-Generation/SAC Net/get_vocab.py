...
if __name__ == '__main__':
    ...
    parser.add_argument('--files', default=['dataset/train_preprocessed/search.train.selected.json', 'dataset/train_preprocessed/zhidao.train.selected.json', 'dataset/dev_preprocessed/search.dev.selected.json', 'dataset/dev_preprocessed/zhidao.dev.selected.json'], nargs='+', required=True,
            help='file list to count vocab from.')
    parser.add_argument('--vocab', default='dataset/total_vocab.pkl', required=True,
